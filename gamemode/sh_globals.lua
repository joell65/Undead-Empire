--did not edit this file much, but if you see this it is stolen
...
--Adds in datatables for certain things to the player, most notably XP.
...
-- Added by Dessert Overlord, WIP.
DT_PLAYER_STRING_PRESTIGE = 0
...
GM.ArsenalCrateCommission = 0.15
...
GM.HumanoidZombiePointRatio = 165
GM.PoisonZombiePointRatio = 200 -- Has an enormous head hitbox
...
GM.AmmoNames["turret_modular"] = "Modular Turrets"
...
GM.AmmoModels["turret_modular"] = "models/Combine_turrets/Floor_turret.mdl"
