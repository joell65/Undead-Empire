...
GM.AmmoCache["pistol"]						= 20		-- Pistols.
...
GM.AmmoCache["turret_modular"]				= 1
GM.AmmoCache["scrap"]						= 3

GM.AmmoResupply = table.ToAssoc({"ar2", "pistol", "smg1", "357", "xbowbolt", "buckshot", "battery", "pulse", "impactmine", "chemical", "gaussenergy", "flashbomb", "grenade", "scrap"})
...
GM:AddStartingItem("3pcp",				ITEMCAT_AMMO,			15,				nil,			"60 pistol ammo",				nil,		"ammo_pistol",			function(pl) pl:GiveAmmo(60, "pistol", true) end)
GM:AddStartingItem("2sgcp",				ITEMCAT_AMMO,			10,				nil,			"24 shotgun ammo",				nil,		"ammo_shotgun",			function(pl) pl:GiveAmmo(24, "buckshot", true) end)
GM:AddStartingItem("3sgcp",				ITEMCAT_AMMO,			15,				nil,			"36 shotgun ammo",				nil,		"ammo_shotgun",			function(pl) pl:GiveAmmo(36, "buckshot", true) end)
GM:AddStartingItem("2smgcp",			ITEMCAT_AMMO,			10,				nil,			"72 SMG ammo",					nil,		"ammo_smg",				function(pl) pl:GiveAmmo(72, "smg1", true) end)
GM:AddStartingItem("3smgcp",			ITEMCAT_AMMO,			15,				nil,			"108 SMG ammo",					nil,		"ammo_smg",				function(pl) pl:GiveAmmo(108, "smg1", true) end)
GM:AddStartingItem("2arcp",				ITEMCAT_AMMO,			10,				nil,			"64 assault rifle ammo",		nil,		"ammo_assault",			function(pl) pl:GiveAmmo(64, "ar2", true) end)
GM:AddStartingItem("3arcp",				ITEMCAT_AMMO,			15,				nil,			"96 assault rifle ammo",		nil,		"ammo_assault",			function(pl) pl:GiveAmmo(96, "ar2", true) end)
GM:AddStartingItem("2rcp",				ITEMCAT_AMMO,			10,				nil,			"16 rifle ammo",				nil,		"ammo_rifle",			function(pl) pl:GiveAmmo(16, "357", true) end)
GM:AddStartingItem("3rcp",				ITEMCAT_AMMO,			15,				nil,			"24 rifle ammo",				nil,		"ammo_rifle",			function(pl) pl:GiveAmmo(24, "357", true) end)
GM:AddStartingItem("2pls",				ITEMCAT_AMMO,			10,				nil,			"60 pulse ammo",				nil,		"ammo_pulse",			function(pl) pl:GiveAmmo(60, "pulse", true) end)
GM:AddStartingItem("3pls",				ITEMCAT_AMMO,			15,				nil,			"90 pulse ammo",				nil,		"ammo_pulse",			function(pl) pl:GiveAmmo(90, "pulse", true) end)
...
--GM:AddStartingItem("drugger",				ITEMCAT_MELEE,			110,				"weapon_zs_drugger")
GM:AddStartingItem("brassknuckles",		ITEMCAT_MELEE,			10,				"weapon_zs_brassknuckles").Model = "models/props_c17/utilityconnecter005.mdl"
GM:AddStartingItem("zpaxe",				ITEMCAT_MELEE,			10,				"weapon_zs_axe")
GM:AddStartingItem("crwbar",			ITEMCAT_MELEE,			10,				"weapon_zs_crowbar")
GM:AddStartingItem("stnbtn",			ITEMCAT_MELEE,			10,				"weapon_zs_stunbaton")
GM:AddStartingItem("csknf",				ITEMCAT_MELEE,			0,				"weapon_zs_swissarmyknife")
...
GM:AddStartingItem("pipe",				ITEMCAT_MELEE,			10,				"weapon_zs_pipe")
GM:AddStartingItem("hook",				ITEMCAT_MELEE,			10,				"weapon_zs_hook")

local item
GM:AddStartingItem("medkit",			ITEMCAT_TOOLS,			25,				"weapon_zs_medicalkit")
GM:AddStartingItem("medgun",			ITEMCAT_TOOLS,			35,				"weapon_zs_medicgun")
item =
GM:AddStartingItem("strengthshot",		ITEMCAT_TOOLS,			35,				"weapon_zs_strengthshot")
...
GM:AddStartingItem("remantler",			ITEMCAT_DEPLOYABLES,			35,				"weapon_zs_remantler")
...
item =
GM:AddStartingItem("blastturret",		ITEMCAT_DEPLOYABLES,			45,				"weapon_zs_gunturret_buckshot",	nil,							nil,									nil,											function(pl) pl:GiveEmptyWeapon("weapon_zs_gunturret_buckshot") pl:GiveAmmo(1, "turret_buckshot") pl:GiveAmmo(30, "buckshot") end)
...
item.NoClassicMode = true
item =
GM:AddStartingItem("zapper",			ITEMCAT_DEPLOYABLES,			30,				"weapon_zs_zapper",				nil,							nil,									nil,											function(pl) pl:GiveEmptyWeapon("weapon_zs_zapper") pl:GiveAmmo(1, "zapper") pl:GiveAmmo(50, "pulse") end)
...
item =
GM:AddStartingItem("pulsedrone",		ITEMCAT_DEPLOYABLES,			45,				"weapon_zs_drone_pulse",		nil,							nil,									nil,											function(pl) pl:GiveEmptyWeapon("weapon_zs_drone_pulse") pl:GiveAmmo(1, "pulse_cutter") pl:GiveAmmo(60, "pulse") end)
...
GM:AddStartingItem("wrench",			ITEMCAT_TOOLS,			15,				"weapon_zs_wrench").NoClassicMode = true
GM:AddStartingItem("crphmr",			ITEMCAT_TOOLS,			25,				"weapon_zs_hammer").NoClassicMode = true
GM:AddStartingItem("junkpack",			ITEMCAT_DEPLOYABLES,	5,				"weapon_zs_boardpack")
--GM:AddStartingItem("woodpack",			ITEMCAT_DEPLOYABLES,	40,				"weapon_zs_woodpack")
--GM:AddStartingItem("woodfort",			ITEMCAT_DEPLOYABLES,	40,				"weapon_zs_woodfort")
--GM:AddStartingItem("woodhouse",			ITEMCAT_DEPLOYABLES,	250,			"weapon_zs_woodhouse")
GM:AddStartingItem("propanetank",		ITEMCAT_TOOLS,			15,				"comp_propanecan")
GM:AddStartingItem("busthead",			ITEMCAT_TOOLS,			45,				"comp_busthead")
GM:AddStartingItem("sawblade",			ITEMCAT_TOOLS,			25,				"comp_sawblade").SkillRequirement = SKILL_U_CRAFTINGPACK
GM:AddStartingItem("cpuparts",			ITEMCAT_TOOLS,			15,				"comp_cpuparts").SkillRequirement = SKILL_U_CRAFTINGPACK
GM:AddStartingItem("electrobattery",	ITEMCAT_TOOLS,			25,				"comp_electrobattery").SkillRequirement = SKILL_U_CRAFTINGPACK
GM:AddStartingItem("modbarrel",			ITEMCAT_TOOLS,			15,				"comp_modbarrel").SkillRequirement = SKILL_U_CRAFTINGPACK
...
GM:AddStartingItem("nightvision",		ITEMCAT_TRINKETS,		10,				"trinket_nightvision").SubCategory =			ITEMSUBCAT_TRINKETS_SPECIAL
...
-- Tier 1
GM:AddPointShopItem("cpist",			ITEMCAT_GUNS,			15,				"weapon_zs_chempistol", nil, nil, nil, function(pl) pl:GiveEmptyWeapon("weapon_zs_chempistol") end)
...
GM:AddPointShopItem("big iron",			ITEMCAT_GUNS,			65,				"weapon_zs_jurisdiction")
...
GM:AddPointShopItem("the cocktail",			ITEMCAT_GUNS,			65,				"weapon_zs_void")
...
GM:AddPointShopItem("bulletstorm",		ITEMCAT_GUNS,			115,			"weapon_zs_bulletstorm")
GM:AddPointShopItem("reaper",			ITEMCAT_GUNS,			115,			"weapon_zs_reaper")
--GM:AddPointShopItem("quicksilver",	ITEMCAT_GUNS,			115,			"weapon_zs_quicksilver")
...
GM:AddPointShopItem("zeus",				ITEMCAT_GUNS,			115,			"weapon_zs_zeus")
GM:AddPointShopItem("stalker",			ITEMCAT_GUNS,			115,			"weapon_zs_m4")
...
GM:AddPointShopItem("dezadon",			ITEMCAT_GUNS,			200,			"weapon_zs_dezadon")
--GM:AddPointShopItem("lasergun",		ITEMCAT_GUNS,			200,			"weapon_zs_lasergun")
--GM:AddPointShopItem("rainmg",			ITEMCAT_GUNS,			200,			"weapon_zs_rain")
--GM:AddPointShopItem("physgun",		ITEMCAT_GUNS,			10000,			"weapon_physgun")
...
item =
GM:AddPointShopItem("scrap",            ITEMCAT_AMMO,           14,              nil,                           "9 scrap",                      nil,                                    "ammo_scrap",                       function(pl) pl:GiveAmmo(9, "scrap", true) end)
item.NoScrapCraft = true
...
GM:AddPointShopItem("25mkit",			ITEMCAT_AMMO,			8,				nil,							"25 Medical Kit power",			"25 extra power for the Medical Kit.",	"ammo_medpower",					function(pl) pl:GiveAmmo(25, "Battery", true) end)
item =
GM:AddPointShopItem("25mkit5x",			ITEMCAT_AMMO,			40,				nil,							"125 Medical Kit power",		"125 extra power for the Medical Kit.",	"ammo_medpower",					function(pl) pl:GiveAmmo(125, "Battery", true) end)
item.NoScrapCraft = true
...
item = 
GM:AddPointShopItem("nail",				ITEMCAT_AMMO,			1,				nil,							"Nail",							"It's just a nail.",					"ammo_nail",						function(pl) pl:GiveAmmo(1, "GaussEnergy", true) end)
item.IsNail = true
...
GM:AddPointShopItem("knife",			ITEMCAT_MELEE,			5,				"weapon_zs_swissarmyknife")
...
GM:AddPointShopItem("powerfists",		ITEMCAT_MELEE,			60,				"weapon_zs_powerfists")
-- Tier 4
...
--Uncomment once turret is complete.
--[[GM:AddPointShopItem("modularturret",	ITEMCAT_DEPLOYABLES,		250,			"weapon_zs_gunturret_modular",	nil,							nil,									nil,											function(pl) pl:GiveEmptyWeapon("weapon_zs_gunturret_modular") pl:GiveAmmo(1, "turret_modular") end)
item.Countables = "prop_gunturret_modular"
item.NoClassicMode = true
--Uncomment once skill is added.
--item.SkillRequirement = SKILL_U_MODULARTURRET]]
...
item =
GM:AddPointShopItem("repairfield",		ITEMCAT_DEPLOYABLES,			45,				"weapon_zs_repairfield",		nil,							nil,									nil,											function(pl) pl:GiveEmptyWeapon("weapon_zs_repairfield") pl:GiveAmmo(1, "repairfield") pl:GiveAmmo(30, "pulse") end)
item.Countables = "prop_repairfield"
item.NoClassicMode = true
item =
GM:AddPointShopItem("zapper",			ITEMCAT_DEPLOYABLES,			40,				"weapon_zs_zapper",				nil,							nil,									nil,											function(pl) pl:GiveEmptyWeapon("weapon_zs_zapper") pl:GiveAmmo(1, "zapper") pl:GiveAmmo(30, "pulse") end)
item.Countables = "prop_zapper"
item.NoClassicMode = true
item =
...
GM:AddPointShopItem("barricadekit",		ITEMCAT_DEPLOYABLES,	50,			"weapon_zs_barricadekit")
GM:AddPointShopItem("junkpack",			ITEMCAT_DEPLOYABLES,		30,			"weapon_zs_boardpack")
//GM:AddPointShopItem("sheetmetal",		ITEMCAT_DEPLOYABLES,	200,			"weapon_zs_metalsheet")
GM:AddPointShopItem("medkit",			ITEMCAT_TOOLS,			25,				"weapon_zs_medicalkit")
GM:AddPointShopItem("medgun",			ITEMCAT_TOOLS,			25,				"weapon_zs_medicgun")
item =
...
item.SkillRequirement = SKILL_U_ANTITODESHOT
GM:AddPointShopItem("medrifle",			ITEMCAT_TOOLS,			50,				"weapon_zs_medicrifle")
...
--GM:AddPointShopItem("stark",			ITEMCAT_TRINKETS,		65,				"trinket_stark").SubCategory =									ITEMSUBCAT_TRINKETS_SPECIAL
--GM:AddPointShopItem("dstalker",			ITEMCAT_TRINKETS,		65,				"trinket_dstalker").SubCategory =								ITEMSUBCAT_TRINKETS_SPECIAL
...
--:AddPointShopItem("sigfragment",		ITEMCAT_OTHER,			30,				"weapon_zs_sigilfragment")
GM:AddPointShopItem("bloodshot",		ITEMCAT_OTHER,			30,				"weapon_zs_bloodshotbomb")
item =
--GM:AddPointShopItem("corruptedfragment",ITEMCAT_OTHER,			60,				"weapon_zs_corruptedfragment")
--item.NoClassicMode = true
--item.SkillRequirement = SKILL_U_CORRUPTEDFRAGMENT
--item =
...
-- Pointshop
	...
	"models/player/lordvipes/h3_spartans_mps/h3spartan_mps_cvp.mdl",
...
GM:AddDeployableInfo("prop_gunturret_modular",	"Modular Turret",	 	"weapon_zs_gunturret_modular")
...
GM.MaxPoisonDamage = 65
GM.MaxBleedDamage = 65
