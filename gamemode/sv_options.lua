--I didn't edit this particular file, but if you see this it's stolen

-- Weapon sets that humans can start with if they choose RANDOM.
GM.StartLoadouts = {
	{"tossr", "3smgcp", "2smgcp", "zpaxe", "portablehole"},
	{"crklr", "3arcp", "2arcp", "zpaxe", "portablehole"},
	{"pshtr", "2pcp", "3pcp", "zpaxe", "portablehole"},
	{"btlax", "2pcp", "3pcp", "zpaxe", "portablehole"},
	{"owens", "2pcp", "3pcp", "zpaxe", "portablehole"},
	{"blstr", "2sgcp", "3sgcp", "6scrap", "csknf", "stone"},
}
...
GM.MaxPropsInBarricade = CreateConVar("zs_maxpropsinbarricade", "100", FCVAR_ARCHIVE + FCVAR_NOTIFY, "Limits the amount of props that can be in one 'contraption' of nails."):GetInt()
cvars.AddChangeCallback("zs_maxpropsinbarricade", function(cvar, oldvalue, newvalue)
	GAMEMODE.MaxPropsInBarricade = tonumber(newvalue) or 100
end)
...
GM.RepairPointsPerHealth = 47.9 -- CreateConVar("zs_repairpointsperhealth", "35", FCVAR_ARCHIVE + FCVAR_NOTIFY, "Specifies the amount of repairing for players to be given a point. For use with nails and such."):GetInt()
